        ...
        <>
          ...
          {Object.prototype.hasOwnProperty.call(story, 'text') && (
            <div
              ...
              key={story.id}>
              <span className='w-4 h-4 bg-gray-800 rounded-full flex justify-center text-xxs text-white items-center p-2 absolute left-1 top-1/2 transform -translate-y-1/2 '>
                {index
                  .toString()
                  .split('')
                  .map((num) => t(`${num}`))}
