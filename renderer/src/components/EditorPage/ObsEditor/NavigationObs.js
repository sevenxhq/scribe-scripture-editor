	...
	<Disclosure>
		{openChapter && (
			<Transition
				...
				<Disclosure.Panel
					className='grid grid-cols-10 gap-x-7 gap-y-5 text-center bg-black text-white text-md font-medium tracking-wide uppercase'
					static>
	...
	return (
		<>
			<div className='flex'>
				<div className='bg-primary text-white py-2 uppercase tracking-wider text-xs font-semibold'>
					<span
						...
						<ChevronLeftIcon
							className='focus:outline-none inline h-4 w-4 mx-1 text-white'
							aria-hidden='true'
						/>
					</span>
			...
			<Transition
				...
				<Dialog
					as='div'
					className='h-full fixed inset-0 z-10 overflow-y-auto'
					...
					<div className='flex items-center justify-center h-screen'>
						<div className='w-5/12 h-72 z-50 flex items-center justify-center bg-black text-white shadow overflow-hidden sm:rounded-lg'>
							<SelectFile
