          ...
          {({ open }) => (
            <>
              ...
              >
                ...
                <td className="px-6 py-4">
                  <div className="text-xs lg:text-sm text-gray-900">{project.language}</div>
                </td>
                <td className="px-6 py-4">
                  <div className="text-xs lg:text-sm text-gray-900">{project.type}</div>
                </td>
                <td className="px-6 py-4 text-xs lg:text-sm text-gray-500">{moment(project.date).format('LL')}</td>
                <td className="px-6 py-4 text-xs lg:text-sm text-gray-500">{moment(project.view, 'YYYY-MM-DD h:mm:ss').fromNow()}</td>
                <td
                ...
                >
                  ...
                  <Menu as="div">
                    ...
                    >
                      <Menu.Items className="absolute right-0 top-14 w-56 mb-1 z-50 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
