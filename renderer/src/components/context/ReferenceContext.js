...
export default function ReferenceContextProvider({ children }) {
  ...
  const [openResource1, setOpenResource1] = useState(false);
  const [openResource2, setOpenResource2] = useState(true);
  const [openResource3, setOpenResource3] = useState(true);
  const [openResource4, setOpenResource4] = useState(true);
